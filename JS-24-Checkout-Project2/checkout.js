      ...
      <div class="card-body">
        ...
        <h5 class="card-title">${name}</h5>
             ...
             <div class="ürün-price">
                  ...
                  <div
                    class="border border-1 border-dark shadow-lg d-flex bg-info justify-content-center p-2"
                  >
                    <div class="adet-controller bg-warning">
...
function calculateTotal() {
  ...
  document.querySelector(".toplam").textContent =
    shipping + ürünToplam + ürünToplam * tax;
}
