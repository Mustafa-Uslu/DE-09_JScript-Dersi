...
harcamaFormu.addEventListener("submit", (e)=>{
    e.preventDefault() //reload u önler
    const yeniHarcama = {  //Girilen değerlerle bir harcama objesi oluşturuyoruz
...
//* Çöp butonuna tıklanınca ilgili satırı siler ve diğer gerekli işlemleri yapar.
harcamaBody.addEventListener("click", (e)=>{
    ...
    if(e.target.classList.contains("fa-trash-can")){
        ...
        // ilgili satırı harcama listesinden kaldırdırır
        harcamaListesi = harcamaListesi.filter((harcama)=> harcama.id != id)

        //yeni oluşan harcamaListesini localStorage  e günceller
        localStorage.setItem("harcamalar", JSON.stringify(harcamaListesi))
        
        //Silinme işleminden sonra hesap kısmını günceller
        hesapla()
