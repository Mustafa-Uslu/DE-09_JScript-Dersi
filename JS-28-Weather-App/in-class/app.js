...
//! Variables   
let apiKey = "7505dab5feb3ae31834f37ac0f780e40";   //* Hc Key:4ed283ae2ece6cf1fe2fe7e75b2ea7a5 
...
form.addEventListener("submit", (e) => {
  ...
  if (input.value) {
      ...
      getWeatherData();
      //input.value=""; //input alanini bosaltmak icin
  }
...
const getWeatherData = async () => {
  ...
  if (userLocation) {
      ...
      userLocation = false;
        ...
        //cardContainer.innerHTML+=card  // gelenleri sonuna ekler 
        cardContainer.append(card)  // gelenleri sonuna ekler 
        //cardContainer.prepend(card)  // gelenleri önüne ekler 
          }
